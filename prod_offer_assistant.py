...
print('\n\n\n')
markdown = Markdown("""# Product Offer AI Assistant (Proof of Concept)""")
console.print(markdown)
markdown = Markdown("""Hello! I'm your virtual assistant designed to help you create new product offers. 
