...
# Example usage:    
# scripts/load_webpage.sh -c "wikipedia_collection" -u "https://en.wikipedia.org/wiki/Mechanician"
# scripts/load_webpage.sh -c "wikipedia_collection" -u "https://en.wikipedia.org/wiki/Artificial_intelligence"
# scripts/load_webpage.sh -c "wikipedia_collection" -u "https://en.wikipedia.org/wiki/Transformer_(deep_learning_architecture)"
